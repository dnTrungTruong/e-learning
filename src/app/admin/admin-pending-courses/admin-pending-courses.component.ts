...
@Component({
  selector: 'app-admin-pending-courses',
  templateUrl: './admin-pending-courses.component.html',
  styleUrls: ['./admin-pending-courses.component.css']
})
export class AdminPendingCoursesComponent implements OnInit {
